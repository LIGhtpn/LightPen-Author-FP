const books = [
    {
        title: "LEVELLING UP",
        cover: "cover1.jpg", // Replace with actual cover image file
        genre: "action",
        links: [
        ...
        blurb: `The earth is suddenly invaded by aliens who call themselves the Daegi... <br><br>
                Roshan, our young MC faces bullying and disgrace due to his lack of abilities, but one day, he stumbles into a ditch and finds a book which granted him access to an unimaginable power...<br><br>
    ...
    },
    {
        ...
        blurb: `Alyssa paused, "You don't believe in love at first sight," she said.<br><br>
                ...
                Christmas takes a wild turn when Alyssa Rodriguez finds herself in a marriage with multi-billionaire Harrison Alexander the Fifth. It becomes a wild game of romance, tension, secret babies, and the ultimate clash of clans.`
    },
    {
...
function openModal(index) {
    ...
    if(book.links.length > 0) {
        book.links.forEach(link => {
            linkContainer.innerHTML += `<a href="${link.url}" target="_blank">Read on ${link.name}</a>`;
        });
    } else {
        linkContainer.innerHTML = '<p>Links coming soon!</p>';
    }

    // Emoji trigger on cover click
